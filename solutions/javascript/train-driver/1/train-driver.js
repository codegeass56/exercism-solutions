...
export function fixListOfWagons(ids) {
  ...
  return [...remainingIds, firstId, secondId];
}
...
export function correctListOfWagons(ids, missingWagons) {
  ...
  return [firstId, ...missingWagons, ...remainingIds];
}
...
export function separateTimeOfArrival(information) {
  const {timeOfArrival, ...remainingInfo} = information;
  return [timeOfArrival, remainingInfo];
}
